            ...
            <ul>
                ...
                foreach ($json->result->languages as $value) {
                    ...
                    if($value->percentage < 80.0) {
                        echo "<li class='text-muted'><img class='flag-$flag' src='https://static.plajer.xyz/img/flag_placeholder_invisible.png'> $value->code - $value->name ($value->percentage% translated) (not implemented)</li>";
                    } else {
                        echo "<li><img class='flag-$flag' src='https://static.plajer.xyz/img/flag_placeholder_invisible.png'> $value->code - $value->name ($value->percentage% translated)</li>";
                    }
                }
                ?>
            </ul>
